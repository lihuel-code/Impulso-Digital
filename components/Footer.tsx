...
export function Footer() {
  return (
    <footer className="bg-ink-900 text-ink-100 mt-32">
      <div className="wrap py-16 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2.5 mb-5">
            <Logo className="h-8 w-8" />
            <span className="font-display text-xl font-semibold text-white">
              Impulso<span className="text-brand-400">.</span>
            </span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li><Link href="/sistema-ventas" className="hover:text-brand-400 transition-colors">Sistema de ventas</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li className="flex items-center gap-2.5"><Mail size={14} className="text-brand-400" /> hola@impulsodigital.com</li>
            <li className="flex items-center gap-2.5"><Phone size={14} className="text-brand-400" /> +54 11 0000 0000</li>
